 ...
 * Usage: botox assumeAwsMfaRoleAutomatically <env>
...
export function assumeAwsMfaRoleAutomaticallyHandler(envArg) {
  ...
  const creds = shell.exec(assumeCmd, { silent: true }).stdout.trim().split(/\s+/);
