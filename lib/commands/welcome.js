...
async function setupConfigInteractive() {
  ...
  const answers = await inquirer.prompt([
    ...
    },
    {
      type: 'input',
      name: 'dev_role_arn',
      message: 'Enter your DEV AWS role ARN:',
      default: 'arn:aws:iam::ACCOUNT_ID_DEV:role/admin-role'
    },
    {
      type: 'input',
      name: 'staging_role_arn',
      message: 'Enter your STAGING AWS role ARN:',
      default: 'arn:aws:iam::ACCOUNT_ID_STAGING:role/admin-role'
    },
    {
      type: 'input',
      name: 'sb_role_arn',
      message: 'Enter your SANDBOX AWS role ARN:',
      default: 'arn:aws:iam::ACCOUNT_ID_SANDBOX:role/admin-role'
    },
    {
      type: 'input',
      name: 'prod_role_arn',
      message: 'Enter your PRODUCTION AWS role ARN:',
      default: 'arn:aws:iam::ACCOUNT_ID_PROD:role/admin-role'
    },
    {
      type: 'input',
      name: 'sec_role_arn',
      message: 'Enter your SECURITY AWS role ARN:',
      default: 'arn:aws:iam::ACCOUNT_ID_SECURITY:role/admin-role'
    },
    {
      type: 'input',
      name: 'mfa_serial',
  ...
  const config = {
    ...
    aws: {
      ...
      roles: {
        prod: {
          env: 'production',
          arn: answers.prod_role_arn
        },
        sb: {
          env: 'sandbox',
          arn: answers.sb_role_arn
        },
        staging: {
          env: 'staging',
          arn: answers.staging_role_arn
        },
        sec: {
          env: 'security',
          arn: answers.sec_role_arn
        },
        dev: {
          env: 'dev',
          arn: answers.dev_role_arn
        }
      }
    },
    argocd: {
